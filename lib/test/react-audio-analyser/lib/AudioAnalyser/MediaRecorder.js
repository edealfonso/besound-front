  ...
  return function (_Target) {
    ...
    function MediaRecorderClass(props) {
      ...
      _this.startAudio = function () {
        ...
        var recorder = _this.mediaRecorder;
                ...
                // ElsaDEV
                console.log('recorder', recorder, recorder?.state)
        ...
        if (!recorder || recorder && recorder.state === "inactive") {
          ...
          if (navigator.mediaDevices.getUserMedia) {
            console.log('navigator.mediaDevices.getUserMedia FOUND')

            navigator.mediaDevices.getUserMedia(constraints).then(function (stream) {
              // ElsaDEV
              console.log('navigator.mediaDevices stream',stream)
            ...
            navigator.getUserMedia(constraints).then(function (stream) {
              _this.recordAudio(stream);
              // ElsaDEV
              console.log('navigator stream',stream)
    ...
    _createClass(MediaRecorderClass, [{
      ...
      value: function recordAudio(stream) {
        ...
        // ELSADEV
        console.log('started media recorder', this.mediaRecorder)
